  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Privacy Policy for RIPPLE App</h1>
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <h3 className="text-xl font-medium text-gray-800 mb-3">a. Personal Information</h3>
        ...
        <h3 className="text-xl font-medium text-gray-800 mb-3">b. Device and Usage Data</h3>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <p className="font-semibold text-gray-900 mb-2">RIPPLE</p>
