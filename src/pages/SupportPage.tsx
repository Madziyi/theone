  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="space-y-6">
          <div className="bg-card border border-border rounded-xl p-6 shadow-soft">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-foreground mb-2">How do I view water monitoring data?</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">How do alerts work?</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">Can I download data?</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">Is my location tracked?</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
            <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Need immediate assistance?</h3>
      ...
      <div className="mt-8 bg-card border border-border rounded-xl p-6">
        <h2 className="text-lg font-semibold text-foreground mb-3">About RIPPLE</h2>
